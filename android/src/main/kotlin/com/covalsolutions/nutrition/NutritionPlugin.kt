...
class NutritionPlugin: MethodCallHandler, ActivityResultListener, Result, ActivityAware, FlutterPlugin {
  ...
  private fun getEnums(result: Result) {
    result.success(NutrientsEnum.values().map { nutrientsEnum -> nutrientsEnum.name  })
  }
